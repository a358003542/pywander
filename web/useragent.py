...
# 将 RewriteEngine 模式打开RewriteEngine OnRewriteBase /# Rewrite 规则 判断用户浏览器类型，如果是手机就跳转到手机网站RewriteCond %{HTTP_USER_AGENT}
#
...
def get_random_user_agent(mobile=False):
    """
    mobile=True 则返回模拟手机的useraget
    """

    if mobile:
        data = user_agent_resource['mobile_browsers']
    else:
        data = user_agent_resource['browsers']
